...
namespace Chwnam\ThreadsToPosts\Vendor\Monolog\Formatter;

use Chwnam\ThreadsToPosts\Vendor\Monolog\Level;
use Chwnam\ThreadsToPosts\Vendor\Gelf\Message;
use Chwnam\ThreadsToPosts\Vendor\Monolog\Utils;
...
class GelfMessageFormatter extends NormalizerFormatter
{
    ...
    public function __construct(?string $systemName = null, ?string $extraPrefix = null, string $contextPrefix = 'ctxt_', ?int $maxLength = null)
    {
        if (!class_exists(Message::class)) {
            throw new \RuntimeException('Composer package graylog2/gelf-php is required to use Chwnam\ThreadsToPosts\Vendor\Monolog\'s GelfMessageFormatter');
        }
