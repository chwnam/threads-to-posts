...
namespace Chwnam\ThreadsToPosts\Vendor\Monolog;

use Closure;
use DateTimeZone;
use Fiber;
use Chwnam\ThreadsToPosts\Vendor\Monolog\Handler\HandlerInterface;
use Chwnam\ThreadsToPosts\Vendor\Monolog\Processor\ProcessorInterface;
use Chwnam\ThreadsToPosts\Vendor\Psr\Log\LoggerInterface;
use Chwnam\ThreadsToPosts\Vendor\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @deprecated Since 3.0, use Chwnam\ThreadsToPosts\Vendor\{@see toMonologLevel} or {@see \Monolog\Level->getName()} instead
     */
