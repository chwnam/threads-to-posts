...
use Chwnam\ThreadsToPosts\Vendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use Chwnam\ThreadsToPosts\Vendor\Monolog\Level;
use Chwnam\ThreadsToPosts\Vendor\Monolog\Formatter\FormatterInterface;
use Chwnam\ThreadsToPosts\Vendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use Chwnam\ThreadsToPosts\Vendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use Chwnam\ThreadsToPosts\Vendor\Elasticsearch\Client;
use Chwnam\ThreadsToPosts\Vendor\Monolog\LogRecord;
use Chwnam\ThreadsToPosts\Vendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use Chwnam\ThreadsToPosts\Vendor\Elastic\Elasticsearch\Client as Client8;
