...
<blockquote class="text-post-media"
            data-text-post-permalink="<?php echo esc_html($this->get('permalink')) ?>"
            data-text-post-version="0" id="ig-tp-<?php echo esc_html($this->get('shortcode')) ?>"
    ...
    <a href="<?php echo esc_html($this->get('permalink')) ?>"
       ...
       target="_blank">
        <div style=" padding: 40px; display: flex; flex-direction: column; align-items: center;">
            ...
            <div style=" font-size: 15px; line-height: 21px; color: #000000; font-weight: 600; "> Threads에서 보기</div>
        </div>
    </a>
</blockquote>
